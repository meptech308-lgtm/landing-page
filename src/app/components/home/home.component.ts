...
export class HomeComponent implements OnInit {
  ...
  featured: FeaturedCategory[] = [
    {
      ...
      head: 'AC EQUIPMENTS',
      description:
        'Complete range of Daikin AC units, VRV systems, and energy-efficient air-conditioning solutions for residential, commercial, and industrial projects.',
    },
    {
      id: 2,
      img: '/images.jpeg',
      ...
      description:
        'High-quality air distribution products including ducting, diffusers, grilles, and louvers designed to optimize airflow and comfort.',
    },
    {
      id: 3,
      img: '/image3.png',
      head: 'VENTILATIONS',
      description:
        'Advanced ventilation solutions including VAVs, Flowbars, and air handling systems to maintain optimal indoor air quality.',
    },
    {
      id: 4,
      img: '/image4.png',
      head: 'CONTROL UNITS',
      description:
        'Smart control systems and automation units for precise temperature, airflow, and energy management across HVAC setups.',
    },
  ];
  ...
  private updateMetaTags(): void {
    ...
    this.titleService.setTitle(
      'Daikin HVAC UAE Dealer | Air Conditioning Solutions | MEPTECH',
    );
    ...
    this.metaService.updateTag({
      name: 'description',
      content:
        'Get premium Daikin HVAC solutions in UAE from a trusted dealer. Explore VRV, split AC, and energy-efficient systems for homes and commercial spaces.',
    });
    ...
    this.metaService.updateTag({
      name: 'keywords',
      content:
        'MEPTECH, DAIKIN AUTHORIZED DEALER, DAIKIN DEALER UAE, HVAC SOLUTIONS UAE, AC UNITS, VRV SYSTEMS, VRF SYSTEMS, FCU, FAN COIL UNITS, AIR DISTRIBUTION, VAV, FLOWBAR, LOUVERS, HVAC DUBAI, AIR CONDITIONING UAE, VENTILATION SYSTEMS',
    });

    // Open Graph Tags
    this.metaService.updateTag({
      property: 'og:title',
      content: 'Daikin HVAC UAE Dealer | Air Conditioning Solutions | MEPTECH',
    });

    this.metaService.updateTag({
      property: 'og:description',
      content:
        'Innovative HVAC solutions including VRV, FCU, and Air Distribution Products. Trusted Daikin dealer in UAE with 15+ years experience.',
    });
    ...
    this.metaService.updateTag({
      ...
      content:
        'End-to-end HVAC solutions including VRV, FCU, and airside products. Reliable Daikin dealer UAE with proven expertise.',
    });
  ...
  private addStructuredData(): void {
    ...
    const organizationSchema = {
      ...
      description:
        'Leading HVAC solutions provider and authorized Daikin dealer in UAE',
